...
server <- function(input, output, session) {
  ...
  createOutput8 <- shiny::reactive({
    ...
    CohortCharacteristics::plotCharacteristics(
      result,
      plotStyle = input$summarise_characteristics_ggplot2_8_plotType,
  ...
  getTidyDataSummariseClinicalRecords <- shiny::reactive({
    res <- data |>
      OmopViewer::filterData("summarise_clinical_records", input) |>
      OmopViewer::tidyData()
  ...
  getTidyDataSummariseRecordCount <- shiny::reactive({
    res <- data |>
      OmopViewer::filterData("summarise_record_count", input) |>
      OmopViewer::tidyData()
